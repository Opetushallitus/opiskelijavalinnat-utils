...
@Getter
@Slf4j
public class OphHttpClient { //implements HealthChecker {
    ...
    public HttpResponse execute(HttpRequestBase req, String contentType, String postOrPutContent, int retry) throws IOException {
        ...
        try {
            ...
            log.error("error in OphHttpClient - " + logUtil.info(req, response, wasJustAuthenticated, wasJustAuthenticated, wasJustAuthenticated, retry), e);
